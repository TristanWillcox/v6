      ...
      import { User, Edit2, MapPin, Link as LinkIcon, Twitter, Github, Trophy, Star, Upload } from 'lucide-react';
      ...
      export function Profile() {
        ...
        const handleAddSpecialization = () => {
          if (specializationInput.trim() && !editProfile.specializations.includes(specializationInput.trim())) {
            setEditProfile({
              ...editProfile,
